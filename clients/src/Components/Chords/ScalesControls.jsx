...
const ScalesControls = ({
  ...
  const chordNames = Object.keys(scalesData);
  ...
  return (
    <div>
      ...
      <ButtonGroup>
        {Array.from({ length: scalesData[selectedChord]?.length || 0 }).map((_, i) => (
          <Button
            key={i}
            $small
